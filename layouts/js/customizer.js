...
( function( $ ) {
	...
	wp.customize( 'themename_theme_bgcolor1', function( value ) {
		value.bind( function( newval ) {
			...
			$( '.site .site-content .content-area .site-main-archive .page-title' ).css({'color': newval});
			...
			$('<style>.site-title a:hover, .widget_posts ul li p:hover, .site .site-content .content-area .site-main-archive .post .entry-header .entry-title a:hover, .site .site-content .content-area .site-main .post .entry-header .entry-title a:hover{color:' + newval + ' !important}</style>').appendTo('head');
			$('<style>.header-menu ul li:hover, .widget-area a:hover, .site-main-single a:hover, .main-navigation a:hover{color:' + newval + ' !important}</style>').appendTo('head');
			$('<style>.site .site-content .content-area .site-main .post .entry-footer a:hover{color:' + newval + ' !important}</style>').appendTo('head');
			$('<style>.site .site-content .content-area .site-main-archive .top-page .post .entry-footer span a:hover{color:' + newval + ' !important}</style>').appendTo('head');
	...
	wp.customize( 'themename_text_color', function( value ) {
		value.bind( function( newval ) {
			$( '.site .site-content .content-area .site-main-archive .no-results .page-content p' ).css({'color': newval});
			$( '.site .site-content .content-area .site-main .entry-summary' ).css({'color': newval});
			$( '.site-main-single .post .entry-header, .site-main-single .post .entry-content p' ).css({'color': newval});
	...
	wp.customize( 'themename_a_bgcolor', function( value ) {
		value.bind( function( newval ) {
			...
			$( '.widget-area a, .pagetop a' ).css({'color': newval});
	...
	wp.customize( 'themename_widget_bgcolor', function( value ) {
		value.bind( function( newval ) {
			$( '.pagetop, .widget' ).css({'background-color': newval});
		} );
	} );
